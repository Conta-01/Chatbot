...
class Config:
    ...
    VIP_LINK = "https://pay.cakto.com.br/izijb3o_514161"
    ...
    AUDIO_DURATION = 7
    IMG_PROFILE = "https://i.ibb.co/Vp2N4FvY/Copiasssa.png"
    IMG_GALLERY = [
...
class Persona:
    ...
    Sabrina: adoro mostrar ela aberta
    Cliente: quero ver
    Resposta: ```json
    {
...
class UiService:
    ...
    def show_call_effect():
        ...
        ">
            ...
            <h3 style="color: #ff66b3; margin-bottom: 5px;">Ligando para Sabrina...</h3>
    ...
    def setup_sidebar():
        with st.sidebar:
            ...
            <div class="vip-badge">
                ...
                <p style="margin: 0; font-size: 1.5em; font-weight: bold;">R$ 45,00/mês</p>
    ...
    def show_offers_page():
        ...
        <div class="package-box package-premium">
            ...
            <div class="package-header">
                ...
                <div class="package-price" style="color: #9400d3;">R$ 89,00</div>
        ...
        <div class="package-box package-extreme">
            <div class="package-header">
                ...
                <div class="package-price" style="color: #ff0066;">R$ 159,00</div>
...
class ChatService:
    ...
    def format_conversation_history(messages, max_messages=10):
        ...
        for msg in messages[-max_messages:]:
            role = "Cliente" if msg["role"] == "user" else "Sabrina"
            content = msg["content"]
            if content == "[ÁUDIO]":
    ...
    if not st.session_state.chat_started:
        ...
        with col2:
            ...
            <div style="text-align: center; margin: 50px 0;">
                ...
                <h2 style="color: #ff66b3; margin-top: 15px;">Sabrina</h2>
